...
import './smartGateLab.css';

export default function SmartGateLabPage() {
  useEffect(() => {
    const script = document.createElement('script');
    script.src = "/assets/smartGateLab.js";
    script.async = true;
  ...
  return (
    <div className="lab-wrapper">
      <header className="lab-topbar">
        <Link className="back-link" href="/smart-gate#mission-6" aria-label="Return to course">← <span>Course</span></Link>
        ...
        <section className="lab-layout" id="labLayout">
          <aside className="parts-panel">
            ...
            <div className="parts-list" id="partsList">
              ...
              <button className="part-card" draggable="true" data-part="led" type="button">
                <span className="part-thumb" aria-hidden="true" style={{background:'#FF4D4D', border:'3px solid #B30000', borderRadius:'50%'}}></span>
                <span><strong>Red/Green LED</strong><small>Indicator</small></span><em>Drag</em>
              </button>
              <button className="part-card" draggable="true" data-part="buzzer" type="button">
                <span className="part-thumb" aria-hidden="true" style={{background:'#333', border:'3px solid #111', borderRadius:'50%'}}></span>
                <span><strong>Buzzer</strong><small>Alarm</small></span><em>Drag</em>
              </button>
          ...
          <section className="workspace-panel">
            <div className="workspace-toolbar">
              <div className="tool-group">
                <button className="tool active" id="selectTool" type="button" aria-pressed="true">Select</button>
                <button className="tool" id="wireTool" type="button" aria-pressed="false">Wire</button>
              </div>
              <div className="workspace-title"><span className="live-dot"></span><strong>Smart Gate Workbench</strong><small id="benchStatus">Place the four required parts</small></div>
              <div className="tool-group">
        ...
        <section className="simulation-stage" id="simulationStage" hidden>
          <div className="simulation-top">
            <div>
              ...
              <h2>Your gate is alive!</h2>
              <p>Move the virtual vehicle. Watch the sensor, Arduino decision, and boom gate response happen in real time.</p>
            </div>
          ...
          <div className="digital-twin-grid">
            <div className="twin-visual">
              <div className="room-scene">
                <span className="wall-label">LAB VIEW: SIDE ELEVATION</span>
                <div className="floor"></div>
                <div className="smart-gate" id="simGate">
                  <div className="sensor-waves"><i></i><i></i><i></i></div>
                  <div className="gate-post">
                    <div className="sim-eyes"><i></i><i></i></div>
                    <div className="sim-led"></div>
                    <b>ARDUINO</b>
                    <small>M1</small>
                  </div>
                  <div className="servo-link"></div>
                  <div className="gate-boom"></div>
                </div>
                <div className="virtual-vehicle" id="virtualVehicle"></div>
              </div>
              <div className="distance-control">
                <label htmlFor="liveDistance"><span>Move vehicle</span><strong><output id="liveDistanceValue">30</output> cm</strong></label>
                <input id="liveDistance" type="range" min="2" max="45" defaultValue="30" />
                <div className="range-labels"><span>Near</span><span>Open zone ≤15 cm</span><span>Far</span></div>
              </div>
            </div>
            ...
            <div className="telemetry-panel">
              <div className="telemetry-grid">
                ...
                <div className="telemetry-card"><span className="telemetry-icon">🧠</span><small>ARDUINO DECISION</small><strong id="decisionText">WAIT</strong><i id="decisionState">CAR IS FAR</i></div>
                <div className="telemetry-card"><span className="telemetry-icon">⚙️</span><small>GATE ANGLE</small><strong><output id="servoAngle">90</output>°</strong><i id="servoState">CLOSED</i></div>
      ...
      <div className="welcome-modal" id="welcomeModal" role="dialog" aria-modal="true" aria-labelledby="welcomeTitle">
        <div className="welcome-card">
          ...
          <div className="welcome-visual">
            ...
            <div className="welcome-gate"><div></div><span></span></div>
          </div>
          <span className="eyebrow">WELCOME, YOUNG INNOVATOR</span>
          <h2 id="welcomeTitle">Build it. Wire it. Watch it detect.</h2>
          <p>You are entering a live engineering lab. Drag real components, connect exact pins and run a digital version of your smart gate before touching the physical kit.</p>
